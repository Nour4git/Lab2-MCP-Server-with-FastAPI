...
exports.codeSamplesGet = codeSamplesGet;
 ...
 */
function codeSamplesGet(client, request, options) {
    return new async_js_1.APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.GetCodeSamplesRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return [parsed, { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = null;
    const path = (0, url_js_1.pathToFunc)("/v1/code_sample")();
    ...
    const [result] = await M.match(M.json("2XX", shared.UsageSnippets$inboundSchema), M.jsonErr("4XX", errors.ErrorT$inboundSchema), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
