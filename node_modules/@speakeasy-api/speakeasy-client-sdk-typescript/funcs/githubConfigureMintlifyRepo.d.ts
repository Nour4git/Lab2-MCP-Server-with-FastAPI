...
export declare function githubConfigureMintlifyRepo(client: SpeakeasyCore, request: shared.GithubConfigureMintlifyRepoRequest, options?: RequestOptions): APIPromise<Result<void, errors.ErrorT | SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
