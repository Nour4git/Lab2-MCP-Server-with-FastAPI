...
exports.publishingTokensList = publishingTokensList;
 ...
 */
function publishingTokensList(client, options) {
...
async function $do(client, options) {
    ...
    const [result] = await M.match(M.json(200, z.array(shared.PublishingToken$inboundSchema)), M.jsonErr("4XX", errors.ErrorT$inboundSchema), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=publishingTokensList.js.map