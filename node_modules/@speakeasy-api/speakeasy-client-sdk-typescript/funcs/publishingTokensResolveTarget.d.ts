 ...
 */
export declare function publishingTokensResolveTarget(client: SpeakeasyCore, request: operations.GetPublishingTokenTargetByIDRequest, options?: RequestOptions): APIPromise<Result<string, errors.ErrorT | SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
