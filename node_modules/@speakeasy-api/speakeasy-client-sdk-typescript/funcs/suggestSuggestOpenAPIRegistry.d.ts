 ...
 */
export declare function suggestSuggestOpenAPIRegistry(client: SpeakeasyCore, request: operations.SuggestOpenAPIRegistryRequest, options?: RequestOptions): APIPromise<Result<ReadableStream<Uint8Array>, SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
