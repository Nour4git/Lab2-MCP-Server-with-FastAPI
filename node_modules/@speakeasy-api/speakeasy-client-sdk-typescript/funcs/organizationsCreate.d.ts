 ...
 */
export declare function organizationsCreate(client: SpeakeasyCore, request: shared.Organization, options?: RequestOptions): APIPromise<Result<shared.Organization, errors.ErrorT | SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
