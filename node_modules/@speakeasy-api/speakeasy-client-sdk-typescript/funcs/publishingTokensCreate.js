...
exports.publishingTokensCreate = publishingTokensCreate;
 ...
 */
function publishingTokensCreate(client, request, options) {
    return new async_js_1.APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.CreatePublishingTokenRequestBody$outboundSchema.optional()
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/publishing-tokens")();
...
//# sourceMappingURL=publishingTokensCreate.js.map