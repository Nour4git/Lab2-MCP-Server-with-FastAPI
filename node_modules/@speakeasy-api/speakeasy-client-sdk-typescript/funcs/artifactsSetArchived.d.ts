 ...
 */
export declare function artifactsSetArchived(client: SpeakeasyCore, request: operations.ArchiveNamespaceRequest, options?: RequestOptions): APIPromise<Result<void, errors.ErrorT | SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
