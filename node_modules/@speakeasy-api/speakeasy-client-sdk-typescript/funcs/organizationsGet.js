...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.GetOrganizationRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/organization/{organizationID}")(pathParams);
    ...
    const [result] = await M.match(M.json("2XX", shared.Organization$inboundSchema), M.jsonErr("4XX", errors.ErrorT$inboundSchema), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
