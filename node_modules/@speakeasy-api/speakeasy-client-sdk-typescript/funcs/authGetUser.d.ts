 ...
 */
export declare function authGetUser(client: SpeakeasyCore, options?: RequestOptions): APIPromise<Result<shared.User, errors.ErrorT | SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
