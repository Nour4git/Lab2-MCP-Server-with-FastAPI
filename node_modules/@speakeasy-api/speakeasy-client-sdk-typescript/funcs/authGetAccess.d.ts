 ...
 */
export declare function authGetAccess(client: SpeakeasyCore, request: operations.GetWorkspaceAccessRequest, options?: RequestOptions): APIPromise<Result<shared.AccessDetails, SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
