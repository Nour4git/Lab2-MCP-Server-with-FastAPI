 ...
 */
function workspacesGet(client, options) {
...
async function $do(client, options) {
    ...
    const [result] = await M.match(M.json("2XX", shared.WorkspaceAndOrganization$inboundSchema), M.jsonErr("4XX", errors.ErrorT$inboundSchema), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
