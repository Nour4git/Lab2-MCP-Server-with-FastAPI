 ...
 */
export declare function organizationsGet(client: SpeakeasyCore, request: operations.GetOrganizationRequest, options?: RequestOptions): APIPromise<Result<shared.Organization, errors.ErrorT | SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
