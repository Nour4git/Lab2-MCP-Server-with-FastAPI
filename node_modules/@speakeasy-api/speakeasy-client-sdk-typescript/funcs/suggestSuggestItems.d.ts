 ...
 */
export declare function suggestSuggestItems(client: SpeakeasyCore, request: shared.SuggestItemsRequestBody, options?: RequestOptions): APIPromise<Result<Array<string>, SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
