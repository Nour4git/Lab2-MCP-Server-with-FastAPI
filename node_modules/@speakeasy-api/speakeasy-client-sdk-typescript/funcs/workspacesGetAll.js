...
exports.workspacesGetAll = workspacesGetAll;
 ...
 */
function workspacesGetAll(client, options) {
    return new async_js_1.APIPromise($do(client, options));
}
async function $do(client, options) {
    const path = (0, url_js_1.pathToFunc)("/v1/workspaces")();
    ...
    const [result] = await M.match(M.json("2XX", z.array(shared.Workspace$inboundSchema)), M.jsonErr("4XX", errors.ErrorT$inboundSchema), M.fail("5XX"))(response, req, { extraFields: responseFields });
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=workspacesGetAll.js.map