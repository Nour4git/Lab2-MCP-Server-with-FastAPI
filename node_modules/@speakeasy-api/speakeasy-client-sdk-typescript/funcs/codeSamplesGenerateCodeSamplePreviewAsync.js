...
exports.codeSamplesGenerateCodeSamplePreviewAsync = codeSamplesGenerateCodeSamplePreviewAsync;
 ...
 */
function codeSamplesGenerateCodeSamplePreviewAsync(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/code_sample/preview/async")();
    ...
    const [result] = await M.match(M.json(202, operations.GenerateCodeSamplePreviewAsyncResponseBody$inboundSchema), M.jsonErr("4XX", errors.ErrorT$inboundSchema), M.jsonErr("5XX", errors.ErrorT$inboundSchema))(response, req, { extraFields: responseFields });
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=codeSamplesGenerateCodeSamplePreviewAsync.js.map