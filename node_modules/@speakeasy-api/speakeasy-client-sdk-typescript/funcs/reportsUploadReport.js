...
exports.reportsUploadReport = reportsUploadReport;
 ...
 * Upload a report.
 */
function reportsUploadReport(client, request, options) {
    return new async_js_1.APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => operations.UploadReportRequestBody$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return [parsed, { status: "invalid" }];
    }
    const payload = parsed.value;
    const body = new FormData();
    (0, encodings_js_1.appendForm)(body, "data", (0, encodings_js_1.encodeJSON)("data", payload.data, { explode: true }));
    ...
    const path = (0, url_js_1.pathToFunc)("/v1/reports")();
    ...
    const [result] = await M.match(M.json("2XX", operations.UploadReportUploadedReport$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req);
    if (!result.ok) {
        return [result, { status: "complete", request: req, response }];
    }
    return [result, { status: "complete", request: req, response }];
}
//# sourceMappingURL=reportsUploadReport.js.map