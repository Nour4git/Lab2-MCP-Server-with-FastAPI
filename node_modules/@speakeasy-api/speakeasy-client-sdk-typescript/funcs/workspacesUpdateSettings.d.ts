 ...
 */
export declare function workspacesUpdateSettings(client: SpeakeasyCore, request: operations.UpdateWorkspaceSettingsRequest, options?: RequestOptions): APIPromise<Result<void, errors.ErrorT | SpeakeasyError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
