...
exports.tool$publishingTokensGet = void 0;
...
exports.tool$publishingTokensGet = {
...
Get information about a particular publishing token.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, publishingTokensGet_js_1.publishingTokensGet)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
