...
exports.tool$workspacesUpdateSettings = void 0;
...
exports.tool$workspacesUpdateSettings = {
...
Update settings about a particular workspace.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, workspacesUpdateSettings_js_1.workspacesUpdateSettings)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
