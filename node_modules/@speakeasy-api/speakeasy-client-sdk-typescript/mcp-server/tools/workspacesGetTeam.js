...
exports.tool$workspacesGetTeam = void 0;
...
exports.tool$workspacesGetTeam = {
    name: "workspaces-get-team",
    description: `Get team members for a particular workspace`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, workspacesGetTeam_js_1.workspacesGetTeam)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
