...
exports.tool$authGetAccessToken = void 0;
...
exports.tool$authGetAccessToken = {
    name: "auth-get-access-token",
    description: `Get or refresh an access token for the current workspace.`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, authGetAccessToken_js_1.authGetAccessToken)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
