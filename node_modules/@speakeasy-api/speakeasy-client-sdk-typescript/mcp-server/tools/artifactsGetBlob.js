...
exports.tool$artifactsGetBlob = void 0;
...
exports.tool$artifactsGetBlob = {
    name: "artifacts-get-blob",
    description: `Get blob for a particular digest`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, artifactsGetBlob_js_1.artifactsGetBlob)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
