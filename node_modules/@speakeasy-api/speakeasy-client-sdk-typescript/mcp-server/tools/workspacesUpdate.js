...
exports.tool$workspacesUpdate = void 0;
...
Update information about a particular workspace.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, workspacesUpdate_js_1.workspacesUpdate)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
