...
exports.tool$organizationsCreateBillingAddOns = void 0;
...
exports.tool$organizationsCreateBillingAddOns = {
    name: "organizations-create-billing-add-ons",
    description: `Create billing add ons`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, organizationsCreateBillingAddOns_js_1.organizationsCreateBillingAddOns)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
