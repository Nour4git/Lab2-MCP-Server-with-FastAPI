...
exports.tool$githubGetAction = void 0;
...
exports.tool$githubGetAction = {
    name: "github-get-action",
    description: ``,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, githubGetAction_js_1.githubGetAction)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
