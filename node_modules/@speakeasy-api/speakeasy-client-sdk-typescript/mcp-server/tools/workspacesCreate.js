...
exports.tool$workspacesCreate = void 0;
...
Creates a workspace`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, workspacesCreate_js_1.workspacesCreate)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
