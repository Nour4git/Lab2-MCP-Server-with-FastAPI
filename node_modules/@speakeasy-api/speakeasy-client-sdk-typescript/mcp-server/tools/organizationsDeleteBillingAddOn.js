...
exports.tool$organizationsDeleteBillingAddOn = void 0;
...
exports.tool$organizationsDeleteBillingAddOn = {
    name: "organizations-delete-billing-add-on",
    description: `Delete billing add ons`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, organizationsDeleteBillingAddOn_js_1.organizationsDeleteBillingAddOn)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
