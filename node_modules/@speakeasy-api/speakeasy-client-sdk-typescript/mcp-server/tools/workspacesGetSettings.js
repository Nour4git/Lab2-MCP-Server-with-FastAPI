...
exports.tool$workspacesGetSettings = void 0;
...
exports.tool$workspacesGetSettings = {
...
Get settings about a particular workspace.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, workspacesGetSettings_js_1.workspacesGetSettings)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
