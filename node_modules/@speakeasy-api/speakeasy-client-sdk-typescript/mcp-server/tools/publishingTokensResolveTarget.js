...
exports.tool$publishingTokensResolveTarget = void 0;
...
exports.tool$publishingTokensResolveTarget = {
...
Get information about a particular publishing token target.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, publishingTokensResolveTarget_js_1.publishingTokensResolveTarget)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
