...
exports.tool$artifactsCreateRemoteSource = void 0;
...
exports.tool$artifactsCreateRemoteSource = {
    name: "artifacts-create-remote-source",
    description: `Configure a new remote source`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, artifactsCreateRemoteSource_js_1.artifactsCreateRemoteSource)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
