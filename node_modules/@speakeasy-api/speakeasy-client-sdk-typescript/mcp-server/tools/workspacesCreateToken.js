...
exports.tool$workspacesCreateToken = void 0;
...
exports.tool$workspacesCreateToken = {
    name: "workspaces-create-token",
    description: `Create a token for a particular workspace`,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, workspacesCreateToken_js_1.workspacesCreateToken)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
