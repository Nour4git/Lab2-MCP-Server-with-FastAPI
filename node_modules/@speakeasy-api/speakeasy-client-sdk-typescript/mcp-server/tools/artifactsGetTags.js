...
exports.tool$artifactsGetTags = void 0;
...
exports.tool$artifactsGetTags = {
    name: "artifacts-get-tags",
    description: ``,
    args,
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, artifactsGetTags_js_1.artifactsGetTags)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
