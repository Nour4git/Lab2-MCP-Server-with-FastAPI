...
exports.tool$codeSamplesGet = void 0;
...
Retrieve usage snippets from an OpenAPI document stored in the registry. Supports filtering by language and operation ID.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, codeSamplesGet_js_1.codeSamplesGet)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
