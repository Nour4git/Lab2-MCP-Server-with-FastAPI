...
exports.tool$workspacesGetByID = void 0;
...
exports.tool$workspacesGetByID = {
...
Get information about a particular workspace.`,
    ...
    tool: async (client, args, ctx) => {
        const [result, apiCall] = await (0, workspacesGetByID_js_1.workspacesGetByID)(client, args.request, { fetchOptions: { signal: ctx.signal } }).$inspect();
        if (!result.ok) {
            return {
